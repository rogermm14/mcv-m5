...
# Model
model_name                   = 'resnet50_v2'   # Model to use ['fcn8' | 'lenet' | 'alexNet' | 'vgg16' |  'vgg19' | 'resnet50' | 'InceptionV3']
...
debug_images_train           = 3000              # N images for training in debug mode (-1 means all)
debug_images_valid           = 600              # N images for validation in debug mode (-1 means all)
debug_images_test            = 600              # N images for testing in debug mode (-1 means all)
debug_n_epochs               = 20               # N of training epochs in debug mode
...
da_rotation_range                  = 20         # Rnd rotation degrees 0-180
da_width_shift_range               = 0.25       # Rnd horizontal shift
da_height_shift_range              = 0.25       # Rnd vertical shift
da_shear_range                     = 0.25       # Shear in radians
