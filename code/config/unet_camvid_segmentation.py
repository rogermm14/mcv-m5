...
da_rotation_range                  = 0.2    # Rnd rotation degrees 0-180
da_width_shift_range               = 0.3    # Rnd horizontal shift
da_height_shift_range              = 0.3    # Rnd vertical shift
da_shear_range                     = 0.3    # Shear in radians
