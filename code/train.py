...
def main():
    ...
    parser.add_argument('-s', '--shared_path', type=str,  #FOR LOCAL
                        default='..', help='Path to shared data folder')
    parser.add_argument('-l', '--local_path', type=str, # FOR LOCAL
    ...
    dataset_path = os.path.join(local_path, 'Datasets') #FOR LOCAL
    #dataset_path = os.path.join(local_path, getuser(), 'Datasets')
    shared_dataset_path = os.path.join(shared_path, 'Datasets')
    #experiments_path = os.path.join(local_path, getuser(), 'Experiments')
    experiments_path = os.path.join(local_path, 'Experiments') # FOR LOCAL
    shared_experiments_path = os.path.join(local_path, getuser(), 'Experiments')
