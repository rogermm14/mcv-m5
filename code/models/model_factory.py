...
from models.resnet import build_resnet50, build_resnet50_v2
...
class Model_Factory():
    ...
    def make(self, cf, optimizer=None):
        if cf.model_name in ['lenet', 'alexNet', 'vgg16', 'vgg19', 'resnet50', 'resnet50_v2',
    ...
    def make_one_net_model(self, cf, in_shape, loss, metrics, optimizer):
        ...
        if cf.model_name == 'fcn8':
            ...
            model = build_segnet(in_shape, cf.dataset.n_classes, cf.weight_decay,
                                 freeze_layers_from=cf.freeze_layers_from,
                                 load_pretrained=cf.load_imageNet, basic=False)
            ...
            model = build_resnet50(in_shape, cf.dataset.n_classes, cf.weight_decay,
                                   load_pretrained=cf.load_imageNet,
                                   freeze_layers_from=cf.freeze_layers_from)
	elif cf.model_name == 'resnet50_v2':
            model = build_resnet50_v2(in_shape, cf.dataset.n_classes, cf.weight_decay,
                                   load_pretrained=cf.load_imageNet,
                                   freeze_layers_from=cf.freeze_layers_from)
